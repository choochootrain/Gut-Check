...
public class AllItemsActivity  extends ListActivity {
      ...
      public void onCreate(Bundle savedInstanceState) {
            ...
            //columns to bind
            String[] columns = new String[] { ItemOpenHelper.COLUMNS[1], ItemOpenHelper.COLUMNS[2], ItemOpenHelper.COLUMNS[3] };
            
            //views to bind to
            int[] to = new int[] { R.id.time_entry, R.id.result_entry, R.id.pending_entry };
